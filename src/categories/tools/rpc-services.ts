import { Category } from "../categories";
 ...
 const rpcServices: Category = {
  ...
  tools: [
    ...
    {
      name: "通义智文",
      description: "论文/文献/报告/网页。AI帮你读懂更多，读得更快，读得更好",
      icon: "https://static.kaolamedia.com/4b/61/4b6111133a693079ab67704e45df3cff/icon",
      link: "#",
    },
    {
      name: "云知写作",
      description: "一款专业的论文编辑工具，基于先进的语义分析，智能AI论文助手",
      icon: "https://static.kaolamedia.com/4b/61/4b6111133a693079ab67704e45df3cff/icon",
      link: "#",
    },
    {
      name: "PaperFree",
      description: "一款全面高效的论文查重系统，致力于为学者和学术界提供更英文",
      icon: "https://static.kaolamedia.com/4b/61/4b6111133a693079ab67704e45df3cff/icon",
      link: "#",
    },
    {
      name: "智绘AI/学术助手",
      description: "智绘AI的一个特点，支持文字、表格、颜色、学术翻译以及论文",
      icon: "https://static.kaolamedia.com/4b/61/4b6111133a693079ab67704e45df3cff/icon",
      link: "#",
    },
    {
      name: "百度橙篇AI",
      description:
        "一个综合性的AI应用商店，主要用于处理和梳理大量、多格式、超长",
      icon: "https://static.kaolamedia.com/4b/61/4b6111133a693079ab67704e45df3cff/icon",
      link: "#",
    },
    {
      name: "青柠学术",
      description:
        "首个学术创作平台，由学术大咖出品，通过国内人文社科领域的精心",
      icon: "https://static.kaolamedia.com/4b/61/4b6111133a693079ab67704e45df3cff/icon",
      link: "#",
    },
  ],
