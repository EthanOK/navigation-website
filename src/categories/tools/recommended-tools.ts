...
const recommendedTools: Category = {
  ...
  tools: [
    ...
    {
      name: "评论私信一键回复",
      description: "评论私信一键回复",
      icon: "/assets/images/web3auth-logo.svg",
      link: "#"
    },
    {
      name: "最新免费模版素材",
      description: "最新免费模版素材",
      icon: "/assets/images/web3auth-logo.svg",
      link: "#"
    },
    {
      name: "创一AI爆客生成神器",
      description: "创一AI爆客生成神器",
      icon: "/assets/images/web3auth-logo.svg",
      link: "#"
    },
    {
      name: "AI免费思维导图",
      description: "AI免费思维导图",
      icon: "/assets/images/web3auth-logo.svg",
      link: "#"
    },
    {
      name: "热门素材源文件下载",
      description: "热门素材源文件下载",
      icon: "/assets/images/web3auth-logo.svg",
      link: "#"
    },
    {
    ...
    {
      name: "熊猫视频号下载助手",
      description: "熊猫视频号下载助手",
      icon: "/assets/images/web3auth-logo.svg",
      link: "#"
    },
    {
      name: "个人免费下载Adobe素材",
      description: "个人免费下载Adobe素材",
      icon: "/assets/images/web3auth-logo.svg",
      link: "#"
    }
  ]
